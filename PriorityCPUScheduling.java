...
public class PriorityCPUScheduling{
    // process {id, arrival, duration, priority}
    final static int[][] initProcess = {{0,6,7,3},{1,0,8,0},{2,13,13,14},{3,20,4,4},{4,14,7,10}};
    ...
    public static void main(String[] args){
        System.out.println("Priority Scheduling (non pre-emptive) : ");
        nonPreemtive();
        System.out.println("==============================================================");
        System.out.println("Priority scheduling (pre-emptive) : ");
        preEmptive();
    }
